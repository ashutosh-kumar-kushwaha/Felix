...
class ParentRecyclerAdapter(val context: Context, val moviesList : List<MoviesList>) : RecyclerView.Adapter<ParentRecyclerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.movieRecyclerView.adapter = RecyclerMoviesAdapter(context, moviesList[position].movies)
    }
